...
<title>서버 프로그램 수행중 에러가 발생했습니다.</title>
<link rel="stylesheet" type="text/css" href="https://www.naver.com/css/err_170424.css?1007" />
...
<div id="wrap">
    <div id="header">
        <p class="menu"><a href="http://www.naver.com/">넥스트아이티</a> | <a href="http://help.naver.com/">넥스트아이티고객센터</a></p>
    </div>
    <div id="container">
        <h2>죄송합니다.<br />서버 프로그램 수행중 에러가 발생했습니다.</h2>
        <div class="content">
        ...
        <form class="search" style="margin-top:50px;" name="search" action="http://search.naver.com/search.naver" method="get" onsubmit="emulAcceptCharset(this);" accept-charset="ks_c_5601-1987">
            ...
            <p class="sch_desc">검색으로 원하시는 페이지를 찾으실 수 있습니다.</p>
        </form>
    </div>
<div id="footer">
<address>
